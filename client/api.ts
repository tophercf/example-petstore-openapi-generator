...
export interface PetApiInterface {
     ...
     */
    addPet(pet: Pet, options?: AxiosRequestConfig): AxiosPromise<Pet>;
     ...
     * @memberof PetApiInterface
     */
    findPetsByStatus(status?: 'available' | 'pending' | 'sold', options?: AxiosRequestConfig): AxiosPromise<Array<Pet>>;
     ...
     * @memberof PetApiInterface
     */
    updatePet(pet: Pet, options?: AxiosRequestConfig): AxiosPromise<Pet>;
     ...
     * @memberof PetApiInterface
     */
    uploadFile(petId: number, additionalMetadata?: string, body?: any, options?: AxiosRequestConfig): AxiosPromise<ApiResponse>;
...
export class PetApi extends BaseAPI implements PetApiInterface {
     ...
     * @memberof PetApi
     */
    public uploadFile(petId: number, additionalMetadata?: string, body?: any, options?: AxiosRequestConfig) {
...
export interface StoreApiInterface {
     ...
     */
    deleteOrder(orderId: number, options?: AxiosRequestConfig): AxiosPromise<void>;
     ...
     * @memberof StoreApiInterface
     */
    placeOrder(order?: Order, options?: AxiosRequestConfig): AxiosPromise<Order>;
...
export interface UserApiInterface {
     ...
     */
    createUser(user?: User, options?: AxiosRequestConfig): AxiosPromise<User>;
     ...
     * @memberof UserApiInterface
     */
    createUsersWithListInput(user?: Array<User>, options?: AxiosRequestConfig): AxiosPromise<User>;
     ...
     * @memberof UserApiInterface
     */
    updateUser(username: string, user?: User, options?: AxiosRequestConfig): AxiosPromise<void>;
